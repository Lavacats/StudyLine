...
//#include "Engine/Plugins/2D/Paper2D/Source/Paper2D/Classes/PaperSprite.h"
...
UPlayerCamera::UPlayerCamera()
{
	...
	PlayerUpperSpringArm->TargetArmLength =500.0f;
...
void UPlayerCamera::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction * ThisTickFunction)
{
	...
	paperSprite->SetWorldLocation(FVector(SpringArm->GetComponentLocation().X, SpringArm->GetComponentLocation().Y, 400.0f));
