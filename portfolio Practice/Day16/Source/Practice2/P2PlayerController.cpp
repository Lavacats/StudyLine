...
void AP2PlayerController::ForwardBack(float NewAxisValue)
{
	...
	if (p2PlayerSate->CheckCurState(E_PlayerState::Player_CLIMING)){
		...
		if (!p2PlayerSate->CheckCurState(E_PlayerState::Player_SHOT) && !p2PlayerSate->CheckCurState(E_PlayerState::Player_SHIELD) && !p2PlayerSate->CheckCurState(E_PlayerState::Player_SWORD)) {
