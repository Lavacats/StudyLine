...
void APlayerTrace::PlayerTraceCheck(FVector playerLocation, FVector playerForwardVector, AActor* playerActer)
{
	...
	//PlayerCounterAttack(playerLocation, playerForwardVector, playerActer);
}
...
void APlayerTrace::PlayerCounterAttack(FVector playerLocation, FVector playerForwardVector, AActor * playerActer)
{
	FHitResult HitResult;
