...
void AP2PlayerController::SetupInputComponent()
{
	...
	InputComponent->BindAction(TEXT("WeaponChangeLeft"), EInputEvent::IE_Pressed, this, &AP2PlayerController::PlayerWeaponChangeLeft);
	InputComponent->BindAction(TEXT("WeaponChangeRight"), EInputEvent::IE_Pressed, this, &AP2PlayerController::PlayerWeaponChangeRight);
...
void AP2PlayerController::PlayerWeaponChangeLeft()
{
...
void AP2PlayerController::PlayerWeaponChangeRight()
{
