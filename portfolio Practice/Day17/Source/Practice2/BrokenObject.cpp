...
ABrokenObject::ABrokenObject()
{
	...
	//StaticComponent->setphysic
	//DestructibleComponent->SetupAttachment(StaticComponent);
	StaticComponent->SetupAttachment(BoxComponent);
	DestructibleComponent->SetupAttachment(BoxComponent);
	//TriggerComponent->SetupAttachment(BoxComponent);
	...
	//DestructibleComponent->OnComponentHit.AddDynamic(this, &ABrokenObject::Damage);
}
...
void ABrokenObject::BeginPlay()
{
	...
	//TriggerComponent->OnComponentBeginOverlap.AddDynamic(this, &ABrokenObject::Trigger);
...
void ABrokenObject::Tick(float DeltaTime)
{
	...
	//StaticComponent->SetRelativeLocation(StaticComponent->GetComponentLocation() + FVector(0, 0, -5.f));
	//DestructibleComponent->SetRelativeLocation(BoxComponent->GetComponentLocation());
