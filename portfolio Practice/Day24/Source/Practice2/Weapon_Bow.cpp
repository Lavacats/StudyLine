...
void AWeapon_Bow::setShieldMesh(const TCHAR * BowMeshText)
{
	UStaticMesh* ReadBowMesh = Cast< UStaticMesh >(StaticLoadObject(UStaticMesh::StaticClass(), NULL, BowMeshText));
	if (ReadBowMesh) {
