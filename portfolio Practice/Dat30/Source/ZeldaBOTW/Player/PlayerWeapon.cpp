...
APlayerWeapon::APlayerWeapon()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh>SK_ARROW_BAG(TEXT("/Game/OBJECT/Bow/BOWBag/SM_MERGED_Quiver_Body__Mt_Leather_14.SM_MERGED_Quiver_Body__Mt_Leather_14"));
