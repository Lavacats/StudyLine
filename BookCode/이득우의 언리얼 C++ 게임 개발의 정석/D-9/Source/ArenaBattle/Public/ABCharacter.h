...
public:
	...
	AABCharacter();
	void SetChracterState(ECharacterState NewState);
	// 캐릭서 상태를 세팅하는 함수
...
private:
	...
	// 캐릭터의 상태를 나타낼 CurrentState

	UPROPERTY(Transient, VisibleInstanceOnly, BlueprintReadOnly, Category = State, Meta = (AllowPrivateAccess = true))
	bool bIsPlayer;
	// 이 캐릭터가 플레이어인지 표시할 불값
	...
	UPROPERTY()
	class ABBPlayerController* ABPlayerController;
